...
const DogGallery = () => {
  ...
  const filteredDogs = useMemo(() => {
    return dogsData.filter(dog => {
      ...
      const matchShelter = !filters.shelterId || dog.shelterId === filters.shelterId;
  ...
  }, [filters.size, filters.sex, filters.shelterId, filters.search]);
      ...
      <div className="container">
        <div className="section-header text-center fade-in">
          ...
          <p className="section-subtitle">
            Actualmente resguardamos a <strong>{dogsData.length} perritos</strong> en nuestros centros. Usa los filtros para conocer a cada uno de ellos y sus condiciones.
          </p>
        </div>
